...
class JointTwoNamedVecListsPubManager(BaseEnvPubManager):
    """
    Env publisher manager with joint measurements and two named-vec-list
    extrinsic channels (e.g. object pose + contact forces).
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.pub_que_dict["extr_pub_que_dict"] = {
            ...
            named_vec_list_channel_2: Queue(),
        }
        ...
        self.publisher_dict[named_vec_list_channel_2] = NamedVecListPublisher(
            ...
            self.pub_que_dict["extr_pub_que_dict"][named_vec_list_channel_2],
        )
